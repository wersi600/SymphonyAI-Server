...
def call_hf_extract_stem_midi(file_path: str, cached_stems: dict = None):
    try:
        ...
        return {
            ...
            "bass_raw_midi_url": normalize_hf_url(result.get("bass_raw_midi_url", "")),
            "drums_raw_midi_url": normalize_hf_url(result.get("drums_raw_midi_url", "")),
            "other_raw_midi_url": normalize_hf_url(result.get("other_raw_midi_url", "")),
...
def run_stem_midi_job(job_id: str):
    ...
    try:
        ...
        for key in (
            "stem_midi_url", "bass_raw_midi_url", "drums_raw_midi_url",
            "other_raw_midi_url", "stem_debug_json_url", "vocal_url",
...
def job_status(job_id: str = Query(...)):
    ...
    return {
        ...
        "bass_raw_midi_url": job.get("bass_raw_midi_url", "") or "",
        "drums_raw_midi_url": job.get("drums_raw_midi_url", "") or "",
        "other_raw_midi_url": job.get("other_raw_midi_url", "") or "",
